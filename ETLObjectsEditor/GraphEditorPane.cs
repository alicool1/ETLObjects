...
{
    public sealed class GraphEditorPane : WindowPane,
                                IOleCommandTarget,
                                IVsPersistDocData,
                                IPersistFileFormat,
                                IVsToolboxUser
    {
        ...
        private GraphEditorControl editorControl;
        ...
        {
            pClassID = ConstCollection.guidEditorFactory;
            return VSConstants.S_OK;
        }
        #endregion IPersist
        ...
        {
            string formatList = string.Format(CultureInfo.CurrentCulture, "Test Editor (*{0}){1}*{0}{1}{1}", Constants.fileExtension, endLine);
